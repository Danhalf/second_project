...
var modals = function modals() {
  ...
  var modalsShow = function modalsShow(triggers, modalSelector, modalCloseTrigger) {
  ...
  openByScroll(".fixed-gift"); //modalsShowByTime(".popup-consultation", 6000);
};
